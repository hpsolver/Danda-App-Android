...
public class Container extends RecyclerView {
  ...
  public static class PlayerViewState extends AbsSavedState {
    ...
    public static final Parcelable.Creator<PlayerViewState> CREATOR =
        new Parcelable.ClassLoaderCreator<PlayerViewState>() { // Added from API 13
  ...
  public static class Behavior extends CoordinatorLayout.Behavior<Container>
    ...
    @Override @ColorInt
    public int getScrimColor(CoordinatorLayout parent, Container child) {

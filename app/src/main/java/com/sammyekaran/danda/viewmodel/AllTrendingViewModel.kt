...
import com.sammyekaran.danda.view.fragment.AllTrendingFragmentDirections
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response


class AllTrendingViewModel(context: Context) : ViewModel() {
    ...
    fun viewProfile(view: View, userId: String) {
        val action = AllTrendingFragmentDirections.actionAllTrendingFragmentToProfileFragment(userId)
    ...
    fun viewComment(view: View, postId: String) {
        val action = AllTrendingFragmentDirections.actionAllTrendingFragmentToCommentFragment(postId)
        view.findNavController().navigate(action)
    ...
    fun report(view: View?, postId: String?, userId: String?) {
        val action = AllTrendingFragmentDirections.actionAllTrendingFragmentToReportFragment(postId!!, userId!!)
        view?.findNavController()?.navigate(action)
    }
